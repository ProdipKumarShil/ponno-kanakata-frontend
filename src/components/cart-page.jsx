                                    ...
                                    {cart.map(item => (
                                        <div key={item.id} className="flex items-center gap-4 p-4">
                                            ...
                                            <div className="flex-grow">
                                                ...
                                                <p className="font-bold text-primary mt-1">৳{language === 'bn' ? toBengaliNumber(item.price.toLocaleString()) : item.price.toLocaleString()}</p>
                                            </div>
                                            <div className="flex flex-col items-end gap-2">
                                                ...
                                                <p className="font-semibold text-right w-24">৳{language === 'bn' ? toBengaliNumber((item.price * item.quantity).toLocaleString()) : (item.price * item.quantity).toLocaleString()}</p>
